...
class PostsRepositoryImpl @Inject constructor(
    ...
    override val posts: Flow<Result<List<Post>, DataError.PostError>> =
        postsRemoteDataSource.getPostsFlow().distinctUntilChanged()

    override suspend fun addPost(postContent: String, imageUrl: String?): Result<Unit, DataError.PostError> {
