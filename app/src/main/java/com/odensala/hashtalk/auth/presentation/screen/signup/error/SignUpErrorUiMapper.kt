...
fun mapEmailErrorToUi(domainError: EmailError): EmailFieldError = when (domainError) {
...
fun mapPasswordErrorToUi(domainError: PasswordError): PasswordFieldError = when (domainError) {
